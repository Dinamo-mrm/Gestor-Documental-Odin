...
-- Tiempo de generación: 07-05-2026 a las 13:27:12
...
--
ALTER TABLE `series`
  MODIFY `id_serie` bigint NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `bitacora`
  ADD CONSTRAINT `bitacora_ibfk_1` FOREIGN KEY (`id_radicado`) REFERENCES `radicados` (`id_radicado`),
  ADD CONSTRAINT `bitacora_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`);
